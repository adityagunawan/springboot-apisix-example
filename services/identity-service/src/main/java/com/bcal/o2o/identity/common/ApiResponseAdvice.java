package com.bcal.o2o.identity.common;
...
public class ApiResponseAdvice implements ResponseBodyAdvice<Object> {
  ...
  public boolean supports(MethodParameter returnType, Class converterType) {
    // Apply only to our app packages to avoid touching actuator, etc.
    return returnType.getContainingClass().getPackageName().startsWith("com.bcal.o2o");
  }
